    ...
    <div class="container px-6 mx-auto grid">
        ...
        <a class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple" href="https://github.com/estevanmaito/windmill-dashboard">
            <div class="flex items-center">
                ...
                <span>Welcome, {{ ucfirst(auth()->user()->name) }} to Cryptospor</span>
            </div>
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                <div class="flex items-center dark:bg-gray-800">
                    <div class="shadow-lg rounded-2xl w-64 bg-white dark:bg-gray-800 p-4">
                        <p class="text-gray-800 dark:text-gray-200 text-xl font-medium mb-4">
                            Basic
                        </p>
                        ...
                        <p class="text-gray-600 dark:text-gray-100  text-xs mt-4">
                            For investors that want to investment small.
                        </p>
                ...
                <div class="flex items-center dark:bg-gray-800">
                    <div class="shadow-lg rounded-2xl w-64 bg-white dark:bg-gray-800 p-4">
                        ...
                        <p class="text-gray-600 dark:text-gray-100  text-xs mt-4">
                            For investors that want to investment a little more.
                        </p>
                        <ul class="text-sm text-gray-600 dark:text-gray-100 w-full mt-6 mb-6">
                            <li class="mb-3 flex items-center ">
                                <svg class="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" width="6" height="6" stroke="currentColor" fill="#10b981" viewBox="0 0 1792 1792">
                ...
                <div class="flex items-center dark:bg-gray-800">
                    <div class="shadow-lg rounded-2xl w-64 bg-white dark:bg-gray-800 p-4">
                        ...
                        <p class="text-gray-600 dark:text-gray-100  text-xs mt-4">
                            For investors that want to invests big.
                        </p>
                        <ul class="text-sm text-gray-600 dark:text-gray-100 w-full mt-6 mb-6">
                            <li class="mb-3 flex items-center ">
                                <svg class="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" width="6" height="6" stroke="currentColor" fill="#10b981" viewBox="0 0 1792 1792">
                ...
                <div class="flex items-center dark:bg-gray-800">
                    <div class="shadow-lg rounded-2xl w-64 bg-white dark:bg-gray-800 p-4">
                        ...
                        <p class="text-gray-600 dark:text-gray-100  text-xs mt-4">
                            For investors that want to invest bigger.
                        </p>
                        <ul class="text-sm text-gray-600 dark:text-gray-100 w-full mt-6 mb-6">
